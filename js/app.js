...
function gotoPage(p){
  // Force URL navigation first. This avoids iPhone/Safari click/SPA issues.
  location.href = pageUrl(p);
}
...
window.addEventListener('popstate',()=>{S.page=new URLSearchParams(location.search).get('page')||'home';render()});
